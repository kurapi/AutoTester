# encoding: UTF-8
# filename: web/lib/helpers/web_testcase_helper.rb

require_relative 'web_utils'
require_relative 'web_yaml_helper'
require_relative 'web_csv_helper'
...
def run_testcase(testcase_hash)
  ...
  @naboss_page.driver.manage.timeouts.implicit_wait = 30
  @funtion_result
