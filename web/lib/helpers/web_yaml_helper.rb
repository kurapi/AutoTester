# encoding: UTF-8
# filename: web/lib/helpers/web_yaml_helper.rb
...
def load_steps_lib
  ...
  steps_yaml_files = File.expand_path(File.join(Dir.pwd, 'web', 'steps', "*.yml"))
...
def load_features_lib
  ...
  features_yaml_files = File.expand_path(File.join(Dir.pwd, 'web', 'features', "*.yml"))
