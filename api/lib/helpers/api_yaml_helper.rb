# filename: api/lib/helpers/api_yaml_helper.rb
...
def load_steps_lib
  ...
  steps_yaml_files = File.expand_path(File.join(Dir.pwd, 'api', 'steps', "*.yml"))
...
def load_features_lib
  ...
  features_yaml_files = File.expand_path(File.join(Dir.pwd, 'api', 'features', "*.yml"))
