...
module Pages
  module Actions
    ...
    def type(text)
      begin
        _type(text)
      rescue Selenium::billDriver::Error::UnknownError => ex
        $LOG.error "Selenium::billDriver::Error::UnknownError: #{ex}".magenta
        scrollToDisplay
        _type(text)
      end
    end
    ...
    def scroll(direction)
      ...
      rescue Selenium::billDriver::Error::JavascriptError
      end
    end
